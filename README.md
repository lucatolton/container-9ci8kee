...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-9ci8kee.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-9ci8kee.containers.anotherwebservice.com/
...
```
git clone git@github.com:lucatolton/container-9ci8kee.git
cd container-9ci8kee
```
...
```
docker attach container-9ci8kee
```
